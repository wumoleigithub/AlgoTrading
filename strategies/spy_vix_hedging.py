...
from utils.volatility_data import get_realtime_vix_and_vx, calculate_hv_exact, calculate_hv, compute_hv_tv_style
...
vix_hv = compute_hv_tv_style(vix_df, period=20)
spy_hv = compute_hv_tv_style(spy_df, period=20)
